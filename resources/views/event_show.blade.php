...
<div class="text_category_list_div">
    <a href="{{ route('event_add', $category->id) }}" class="add_btn_a">新規追加</a>
    ...
    <div class="category_list" style="margin-top:50px;">
        ...
        <div class="text_list_column">
            ...
            <div class="event_btn_list">
                <a href="{{ route('event_add', $category->id) }}" class="add_btn_a">予約追加</a>
                <a href="{{ route('event_add', $category->id) }}" class="view_btn_a" style="width:100px;">表示</a>
