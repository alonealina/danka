            ...
            <div class="hikuyousya_regist_form">
                ...
                <div class="">
                    ...
                    <div class="danka_column">
                        ...
                        {{ Form::text('ihai_no', $ihai_no, ['class' => 'danka_form_text2', 'maxlength' => 6, 'style' => 'width: 70px;']) }}
                    </div>
                    ...
                    <div class="danka_column">
                        ...
                        {{ Form::text('column', $hikuyousya->column, ['class' => 'danka_form_text2', 'maxlength' => 100, 'style' => 'width: 500px;', 'placeholder' => '骨のぼり、絵天井　XX列XX番、灯籠']) }}
                    </div>
